...
<body>
<div class="container">
<form class="form" action="chat_user_insert.php" method="post">
  <div class="title">Welcome,<br><span>sign up to continue</span></div>
  <input type="text" name="name" class="input" placeholder="Username" autocomplete="off">
  <input type="text" placeholder="LoginID" name="lid" class="input">
  <input type="text" placeholder="LoginPW" name="lpw" class="input">
