...
//3．データ登録SQL作成
$sql ="SELECT * FROM 2ch_user_table ";
...
<body>
<div class="container">
<form class="form" action="chat_login_act.php" method="post">
  <div class="title">Welcome,<br><span>login up to continue</span></div>
  <input type="text" placeholder="userID" name="lid" class="input">
  <input type="password" placeholder="Password" name="lpw" id="textPassword" class="input">
